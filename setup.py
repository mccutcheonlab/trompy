...
setup(
  ...
  version = '0.12.0',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/mccutcheonlab/trompy/archive/v0.12.0-alpha.tar.gz',    # I explain this later on
